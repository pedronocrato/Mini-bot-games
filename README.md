...
2. Crie um bot no Telegram via [@BotFather](https://t.me/botfather) e copie o token gerado

3. Crie um arquivo `.env` na raiz do projeto
```
MINIGAME_TOKENN=seu_token_aqui
```

4. Execute o bot
```bash
python minibotgames.py
```
